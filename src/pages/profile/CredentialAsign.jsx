        ...
        <div className={css.form}>
          <div className={css.instructions}>
            <p>
              ...
              <span>Siempremás</span> puedes vincular tu perfil con la cuenta de
              email que acabas de utilizar. Vincúlalo con tu N° de DNI o tu N°
              de credencial.
            </p>
            <p>
              La próxima vez que te loguees, lo harás con tu mail y podrás ver
              tus puntos e historial de compras.
            </p>
            <p>
              Si no eres socio de Siempre, <span>asóciate gratis!</span>
            </p>
          </div>
          ...
          <div className={css.contentBtn}>
            ...
            <button onClick={handleAfiliate} className="btn__secondary">
